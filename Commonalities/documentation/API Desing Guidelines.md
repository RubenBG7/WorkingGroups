...
[Link to Common Data Types documentation repository](https://github.com/camaraproject/WorkingGroups/blob/main/Commonalities/documentation/Working/CAMARA_common.json)
...
| ----- |	-----  |	 -----  |  -----  |
| Equal | `GET .../?name=Juan` | `GET .../?amount=807.24`	| `GET .../?execution_date=2018-30-05` | 
...
- <u>Greater than / less than</u>: new attribute will be created and it will be preceded with the suffixes \.(gte|gt|lte|lt)$.
  - `GET /users?creatrion_date.gte=2021-01-01T00:00:00`
